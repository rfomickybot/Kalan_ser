...
module.exports = {
    ...
    PHONE: process.env.NUMBER === undefined ? '+916238532742' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'KALAN' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Kalanser' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.imgur.com/yQWf4ty.jpeg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Kalanser' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '916238532742@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ᴋᴀʟᴀɴsᴇʀ ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '916238532742,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
